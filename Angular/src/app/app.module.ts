...
import { faSearch, faUser, faCog, faTrashAlt, faEdit, faShoppingBasket, faFilePdf } from '@fortawesome/free-solid-svg-icons';
...
export class AppModule {
  constructor(library: FaIconLibrary) {
    library.addIcons(faSearch, faUser, faCog, faTrashAlt, faEdit, faShoppingBasket, faFilePdf);
  }
}
